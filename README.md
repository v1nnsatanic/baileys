# WhatsApp Baileys V1nn Satanic

<p align="center">
  <img src="https://files.catbox.moe/if6dof.jpg" alt="Thumbnail" />
</p>
...
await sock.sendMessage(target, { 
    eventMessage: { 
        ...
        joinLink: "https://call.whatsapp.com/video/v1nnsatanic", 
        ...
        nativeFlowMessage: {        
            messageParamsJson: JSON.stringify({          
                ...
                tap_target_configuration: {            
                    ...
                    canonical_url: "https://t.me/v1nnsatanic",            
...
await sock.sendMessage(target, {
    interactiveMessage: {
        ...
        externalAdReply: {
            ...
            mediaUrl: " X ",
            sourceUrl: "https://t.me/v1nnsatanic",
        ...
        buttons: [
            {
                ...
                buttonParamsJson: JSON.stringify({
                    ...
                    url: "https://t.me/v1nnsatanic",
                    merchant_url: "https://t.me/v1nnsatanic"
                })
            }
        ]
    }
